        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4">
          ...
          <div className="w-full max-w-sm rounded-xl border border-slate-700 bg-slate-900 p-6 shadow-2xl">
            ...
            <div className="flex justify-center">
              ...
              <div
                className={`flex h-14 w-14 items-center justify-center rounded-full text-2xl ${modalData.type === "success"
            ...
            <button
              ...
              className={`mt-6 w-full rounded-lg py-3 font-semibold ${modalData.type === "success"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="block space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  className="min-h-11 w-full rounded-lg border border-slate-700 bg-slate-800 px-4 pr-12 text-white placeholder-slate-500 outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/30"
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 -translate-y-1/2 text-orange-500 hover:text-orange-400"
                >
                  <FaEye size={18} />
                </button>
            ...
            <label className="block space-y-2">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-orange-500 hover:text-orange-400"
                >
                  <FaEye size={18} />
                </button>
